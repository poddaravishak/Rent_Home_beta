...
public class editProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userinfoDisplay((CircleImageView) pro_pic1,name,email,username,address,contactNo);
       ...
       pro_pic1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    if(snapshot.child("ImageUri").exists()){
                        ...
                        Picasso.get().load(imageUri).into(pro_pic1);
...
//image_add
                       ...
                       String address1= snapshot.child("Address").getValue().toString();String contactNo1=snapshot.child("ContactNo").getValue().toString();
